...
public class AppSwing {
  public static void main(String [] args) throws Exception {
    ...
    //KeyboardControlledTankOperator p1t1 = new KeyboardControlledTankOperator("p1t1", 60, 20, gameState, gameState.getYou(), Directed.Direction.LEFT);
    //gameState.add(p1t1);
   ...
   // MouseControlledTankOperator p1t2 = new MouseControlledTankOperator("p1t2", 40, 60, gameState, gameState.getYou(), Directed.Direction.DOWN);
   // gameState.add(p1t2);
    app.setVisible(true);
    app.run();
  }
